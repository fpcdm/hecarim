...
#define TSDesignFileName @"Framework.bundle/TSMessagesDefaultDesign"
...
- (UIImage *)bundledImageNamed:(NSString*)name{
    ...
    NSString *imagePath = [bundle pathForResource:[NSString stringWithFormat:@"Framework.bundle/%@", name] ofType:nil];
