...
{
    RestKitUtil *sharedClient = [RestKitUtil sharedClient];
    RKRequestDescriptor *requestDescriptor = [sharedClient addRequestDescriptor:[CaseEntity class] mappingParam:@{@"typeId": @"type", @"customerRemark": @"remark", @"buyerAddress": @"address", @"addressId": @"address_id", @"propertyId": @"property", @"merchantId": @"merchant_id", @"source": @"source", @"sourceId": @"source_id"}];
